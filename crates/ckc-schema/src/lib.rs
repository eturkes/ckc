...
//! the SPEC.md declaration extractor (.2), and the symbol table +
//! resolution checker (.3) are in place; the v0 registry build (.4)
//! completes `T-Registry-Referential-Integrity`.
