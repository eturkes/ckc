//! The seven string policies of SPEC §10 as deterministic normalizers.
//!
...
/// A SPEC §10 string policy. Serializes to the spec's snake_case policy name so
...
/// omits the leading-`[a-z]` requirement (SPEC §10 vs §9).
